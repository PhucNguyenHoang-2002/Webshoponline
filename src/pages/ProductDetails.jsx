  ...
  return (
    <Helmet title={productName}>
      ...
      <section className=" pt-0">
        <Container>
          <Row>
            <Col className="imgProducts " lg="6">
              <img src={imgUrl} alt="" />
            </Col>
            ...
            <Col lg="6">
              <div className="product__details">
                ...
                <div className="product__rating d-flex align-item-center gap-5 mb-4">
                  ...
                  <p><span>{avgRating}</span> Đánh giá</p>
                </div>
                <div className="d-flex algin-item-center gap-5">
        ...
        <Container>
          <Row>
                      ...
                      <form action="" onSubmit={submitHandler}>
                        ...
                        <div className="form__group">
                          <textarea
                            ...
                            rows={4}
                            type="text"
                            placeholder="Nhập lời bình của bạn" />
                        </div>
                        <motion.button whileTap={{ scale: 1.2 }}
            ...
            <Col lg="12" className="mt-5">
              <h2 className="ralateed__title">You might also like</h2>
            </Col>
